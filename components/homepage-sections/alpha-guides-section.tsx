  ...
  return (
    <section className="alpha-section bg-white">
      ...
      <AnimatedSection animation="fade-up" delay={200}>
        <div 
          className="alpha-card !p-[var(--space-lg)] text-[var(--color-dark-green)] bg-[var(--color-light-green)] mb-[var(--space-xl)] flex flex-col md:flex-row md:flex-wrap lg:flex-nowrap gap-[var(--space-md)]"
        >
