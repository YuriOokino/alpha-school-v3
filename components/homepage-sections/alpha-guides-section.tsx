...
export default function AlphaGuidesSection() {
  ...
  return (
    <section className="alpha-section bg-white">
      ...
      <div 
        ref={ref}
        className={`alpha-card !p-[var(--space-lg)] text-[var(--color-dark-green)] bg-[var(--color-light-green)] mb-[var(--space-xl)] flex flex-col md:flex-row md:flex-wrap lg:flex-nowrap gap-[var(--space-md)] ${hasAnimated ? 'animate-fade-up' : 'opacity-0 translate-y-8'}`}
      >
        <div className="flex flex-col justify-between min-w-0 w-full md:w-1/2 lg:w-1/3">
