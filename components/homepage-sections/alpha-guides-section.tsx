  ...
  return (
    <section className="alpha-section bg-white">
      ...
      <div className="flex flex-col md:flex-row gap-[var(--space-lg)] mb-[var(--space-xl)] items-stretch">
        {/* Guidance Card */}
        <div className="alpha-card bg-[var(--color-sky-blue)] w-full flex flex-col justify-between">
        ...
        {/* Support Card */}
        <div className="alpha-card bg-[var(--color-light-green)] w-full flex flex-col justify-between">
