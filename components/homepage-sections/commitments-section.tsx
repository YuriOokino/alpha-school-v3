...
export default function CommitmentsSection() {
  return (
    <section className="alpha-section bg-white">
      <div className="w-full bg-[var(--color-primary)] rounded-[var(--radius-lg)] p-[var(--space-lg)] flex flex-col gap-[var(--space-xl)]">
        <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-[var(--space-md)] gap-4">
          <h2 className="text-[var(--color-primary-light)] m-0">Alpha's 3 Commitments</h2>
          <Button variant="lightBlue" href="/the-program" className="shrink-0 gap-2">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-[var(--space-lg)] justify-between items-stretch">
          {commitments.map((commitment, index) => (
            <div key={index} className="flex flex-col items-start bg-[var(--color-primary-light)] rounded-[var(--radius-lg)] p-[var(--space-md)]">
              <div className="w-full flex justify-end mb-2">
                <Button size="icon" className="block bg-[var(--color-primary)]" style={{ transform: 'rotate(-45deg)' }}>
                  <svg width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M5.293 12.293L6.707 13.707L13.414 6.99997L6.707 0.292969L5.293 1.70697L9.586 5.99997H0V7.99997H9.586L5.293 12.293Z" fill="currentColor"/>
                  </svg>
                </Button>
              ...
              <div className="grid grid-cols-2 gap-1 mb-[var(--space-lg)]">
                {index === 0 ? (
                  <svg width="74" height="79" viewBox="0 0 74 62" fill="none" xmlns="http://www.w3.org/2000/svg" className="text-[var(--color-primary)]">
                  ...
                  <svg width="47" height="44" viewBox="0 0 47 44" fill="none" xmlns="http://www.w3.org/2000/svg" className="text-[var(--color-primary)]">
                  ...
                  <svg width="53" height="53" viewBox="0 0 53 53" fill="none" xmlns="http://www.w3.org/2000/svg" className="text-[var(--color-primary)]">
              ...
              <h3 className="text-[var(--color-primary)] heading-style-h4 mb-4">{commitment.title}</h3>
              <p className="text-[var(--color-primary)] mb-4">{commitment.description}</p>
            </div>
          ))}
        </div>
      </div>
