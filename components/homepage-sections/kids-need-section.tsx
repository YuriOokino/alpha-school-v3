...
export default function KidsNeedSection() {
  return (
    <section className="alpha-section bg-[var(--color-bg-muted)]">
      ...
      <div className="flex flex-col md:flex-row gap-6 mb-6 md:mb-[var(--space-4xl)] justify-center">
        <div className="alpha-card w-full min-w-0 bg-[var(--color-sky-blue)] rounded-2xl p-6 md:max-w-[500px]">
        ...
        <div className="alpha-card w-full min-w-0 bg-[var(--color-primary)] rounded-2xl p-6 md:max-w-[500px]">
