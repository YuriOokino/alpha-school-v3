...
export default function ResourcesCard({ campus, className = "" }: ResourcesCardProps) {
  return (
    <div className={`max-w-[1100px] mb-[var(--space-4xl)] mx-auto animate-on-scroll animate-fade-up ${className}`}>
      <div className="bg-[var(--color-sky-blue)] text-[var(--color-primary)] w-[95%] min-h-[400px] m-auto rounded-[var(--radius-lg)] p-[var(--space-lg)] flex flex-col md:flex-row gap-[var(--space-xl)] items-start">
        <div className="flex-1">
          ...
          <CampusApplicationLink 
            ...
            className="centered-icon-text mt-[var(--space-md)] md:mt-[var(--space-sm)] bg-[var(--color-primary)]"
          >
        ...
        <div className="flex-1">
          ...
          <div className="space-y-2">
            <Button radius="small" className="mr-4 bg-[var(--color-primary)] text-[var(--color-sky-blue)] uppercase" href="/admission">
              Admission Guide
            </Button>
            <Button variant="outline" radius="small" className="icon-text-center outline-[var(--color-primary)] uppercase" href="/downloads/Alpha School - Sample School Schedule.pdf">
              School schedule<span className="material-icons-outlined">file_download</span>
            </Button>
            <Button variant="outline" radius="small" className="uppercase outline-[var(--color-primary)] icon-text-center mr-4" href="/downloads/Alpha School - Tuition Overview.pdf" target="_blank">
              Tuition Overview<span className="material-icons-outlined">file_download</span>
            </Button>
            <Button radius="small" className="mr-4 bg-[var(--color-primary)] text-[var(--color-sky-blue)] uppercase" href="/video-library">
              Video library
            </Button>
            <Button variant="outline" radius="small" className="mr-4 outline-[var(--color-primary)] icon-text-centered uppercase" href="/downloads/Alpha School 25-26 Calendar.pdf" target="_blank">
              24/25 Calendar<span className="material-icons-outlined">file_download</span>
            </Button>
            <Button variant="outline" radius="small" className="outline-[var(--color-primary)] icon-text-centered uppercase" href="#" target="_blank">
