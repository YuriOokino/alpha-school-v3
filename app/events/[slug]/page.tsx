...
export default function ExperienceAlphaFortWorthPage() {
  // Find the specific event data
  const eventData = events.find(event => event.id === "experience-alpha-fort-worth")
  ...
  return (
    <main>
      <MainHeading variant="light">
        {eventData?.title || "Experience Alpha Fort Worth"}
      </MainHeading>
      <section className="alpha-section">
        <div className="flex flex-col md:flex-row gap-[var(--space-lg)] md:items-start">
          ...
          <div className="alpha-card scheme-pink w-full md:w-2/5">
            <h3 className="mb-[var(--space-md)]">Parent Information Evening</h3>
            <div className="flex items-center gap-2 mb-1">
              ...
              <span>{eventData?.date || "June 16, 2025"}</span>
            </div>
            <div className="flex items-center gap-2 mb-1">
              {/* Clock SVG */}
              <span>
              ...
              <span>{eventData?.time || "6:00 - 8:00 PM"}</span>
            </div>
            <div className="flex items-center gap-2 mb-4">
              ...
              <span>{eventData?.address || "CEBA Ballroom, 3300 Bryant Irvin Rd, Fort Worth, TX 76109"}</span>
            </div>
          ...
          <div className="flex-1">
            <h2 className="mb-[var(--space-sm)]">Experience the Magic of Alpha in Fort Worth</h2>
            <p className="mb-[var(--space-sm)]">Get an inside look at Alpha's groundbreaking learning model at this exclusive parent-only event.</p>
            <p className="mb-[var(--space-sm)]">Parents will experience the magic of Alpha with our team, be able to connect with other families, and discover how our students excel in core academics in just two hours a day.</p>
            <p className="mb-[var(--space-sm)]">Light appetizers and wine will be served.</p>
            ...
            <ul className="mb-[var(--space-sm)] space-y-2">
              <li className="flex items-start gap-2">
                ...
                <span>
                  <b>See Alpha in Action</b> – Hear firsthand how students excel in core academics in a fraction of the time of traditional schools and find and fuel their purpose.
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="mt-1">
                ...
                <span>
                  <b>Meet the Team</b> – Ask questions about academics, motivation, and daily life at Alpha—discover how our model can transform your child's education.
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="mt-1">
                ...
                <span>
                  <b>Connect with Families</b> – Meet like-minded parents who share your vision for education and join our founding family community—building relationships that will support both you and your child along the way.
                </span>
              </li>
            </ul>
