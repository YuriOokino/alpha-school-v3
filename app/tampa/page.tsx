...
export default async function TampaPage() {
  ...
  const campus = campuses.find(c => c.name === "Tampa")
  
  if (!campus) {
    throw new Error("Tampa campus not found in campus data")
  }
  ...
  const welcomeRightColumn = (
    <>
      ...
      <p>Bringing Alpha School's three commitments—love school, learn 2x in 2 hours, and master life skills—to your city. <strong>Alpha Tampa is launching soon and now accepting applications.</strong></p>
    </>
  )
  
  const galleryImages = [
    { src: "/assets/locations/tampa/gallery/tampa-1.webp", alt: "Tampa campus photo" },
    { src: "/assets/locations/tampa/gallery/tampa-2.webp", alt: "Tampa campus photo" },
    { src: "/assets/locations/tampa/gallery/tampa-3.webp", alt: "Tampa campus photo" },
    { src: "/assets/locations/tampa/gallery/tampa-4.webp", alt: "Tampa campus photo" },
    { src: "/assets/locations/tampa/gallery/tampa-5.webp", alt: "Tampa campus photo" },
    { src: "/assets/locations/tampa/gallery/tampa-6.webp", alt: "Tampa campus photo" },
    { src: "/assets/locations/tampa/gallery/tampa-7.webp", alt: "Tampa campus photo" },
    { src: "/assets/locations/tampa/gallery/tampa-8.webp", alt: "Tampa campus photo" },
    { src: "/assets/locations/tampa/gallery/tampa-9.webp", alt: "Tampa campus photo" },
    { src: "/assets/locations/tampa/gallery/tampa-10.webp", alt: "Tampa campus photo" },
    { src: "/assets/locations/tampa/gallery/tampa-11.webp", alt: "Tampa campus photo" },
    { src: "/assets/locations/tampa/gallery/tampa-12.webp", alt: "Tampa campus photo" }
  ]
  ...
  return (
    <main className="bg-[var(--color-bg-muted)]">
      ...
      <MediaHeading
        ...
        media={<img src="/assets/locations/tampa/hero/tampa-hero.webp" alt="Tampa Campus" />}
      >
      ...
      <div className="alpha-section">
        <div className="flex justify-center">
          <VideoPlayer
            ...
            posterImage="/assets/feature-video-overlays/tampa-video-preview.webp"
            posterAlt="Tampa Campus Video Preview"
            aspectRatio="16/9"
      ...
      */}
      ...
      <section className="alpha-section bg-white">
        <div className="campus-info">
          <div className="flex-1">
            <h2 className="heading-style-h2 mb-4">Tampa Campus</h2>
            <ul className="body-text mb-4">
              <li>
                {shouldShowGoogleMapsLink(campus.address) ? (
                  <a 
                    href={getGoogleMapsUrl(campus.address)}
                    target="_blank" 
      ...
      <section className="alpha-section bg-white">
        ...
        {events.filter(e => 
          e.locationTag.toLowerCase().includes("tampa") || 
          e.title.toLowerCase().includes("tampa") || 
          e.address.toLowerCase().includes("tampa")
        ).length > 0 ? (
          <EventsCarousel 
            events={events} 
            locationFilter="tampa" 
          ...
          <div className="text-center">
            <p className="body-text mb-4">No events currently scheduled for Tampa.</p>
