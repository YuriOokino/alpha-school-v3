...
export default async function PortlandPage() {
  const events = await loadEvents()
  const campus = campuses.find(c => c.name === "Portland")
  
  if (!campus) {
    throw new Error("Portland campus not found in campus data")
  }
  ...
  const welcomeRightColumn = (
    <>
      ...
      <p>Bringing Alpha School's three commitments—love school, learn 2x in 2 hours, and master life skills—to your city. <strong>Alpha Portland is launching soon and now accepting applications.</strong></p>
    </>
  )
  
  const galleryImages = [
    { src: "/assets/locations/portland/gallery/portland-1.webp", alt: "Portland campus photo" },
    { src: "/assets/locations/portland/gallery/portland-2.webp", alt: "Portland campus photo" },
    { src: "/assets/locations/portland/gallery/portland-3.webp", alt: "Portland campus photo" },
    { src: "/assets/locations/portland/gallery/portland-4.webp", alt: "Portland campus photo" },
    { src: "/assets/locations/portland/gallery/portland-5.webp", alt: "Portland campus photo" },
    { src: "/assets/locations/portland/gallery/portland-6.webp", alt: "Portland campus photo" },
    { src: "/assets/locations/portland/gallery/portland-7.webp", alt: "Portland campus photo" },
    { src: "/assets/locations/portland/gallery/portland-8.webp", alt: "Portland campus photo" },
    { src: "/assets/locations/portland/gallery/portland-9.webp", alt: "Portland campus photo" },
    { src: "/assets/locations/portland/gallery/portland-10.webp", alt: "Portland campus photo" },
    { src: "/assets/locations/portland/gallery/portland-11.webp", alt: "Portland campus photo" },
    { src: "/assets/locations/portland/gallery/portland-12.webp", alt: "Portland campus photo" }
  ]
  ...
  return (
    <main className="bg-[var(--color-bg-muted)]">
      ...
      <MediaHeading
        ...
        media={<img src="/assets/locations/portland/hero/portland-hero.webp" alt="Portland Campus" />}
      >
      ...
      <div className="alpha-section">
        <div className="flex justify-center">
          <VideoPlayer
            ...
            posterImage="/assets/feature-video-overlays/portland-video-preview.webp"
            posterAlt="Portland Campus Video Preview"
            aspectRatio="16/9"
      ...
      */}
      ...
      <section className="alpha-section bg-white">
        <div className="campus-info">
          <div className="flex-1">
            <h2 className="heading-style-h2 mb-4">Portland Campus</h2>
      ...
      <section className="alpha-section bg-white">
        ...
        {events.filter(e => 
          e.locationTag.toLowerCase().includes("portland") || 
          e.title.toLowerCase().includes("portland") || 
          e.address.toLowerCase().includes("portland")
        ).length > 0 ? (
          <EventsCarousel 
            events={events} 
            locationFilter="portland" 
          ...
          <div className="text-center">
            <p className="body-text mb-4">No events currently scheduled for Portland.</p>
