  ...
  return (
    <main className="bg-[var(--color-bg-muted)]">
      ...
      <MediaHeading
        ...
        media={<img src="/assets/locations/las-vegas/hero/las-vegas-hero.webp" alt="Las Vegas Campus" />}
      >
        Private School in Las Vegas
      ...
      */}
      ...
      <section className="alpha-section bg-white">
        <div className="campus-info">
          <div className="flex-1">
            <h2 className="heading-style-h2 mb-4">Las Vegas Campus</h2>
      ...
      <section className="alpha-section bg-white">
        ...
        {events.filter(e => 
          e.locationTag.toLowerCase().includes("las-vegas") || 
          e.title.toLowerCase().includes("las-vegas") || 
          e.address.toLowerCase().includes("las-vegas")
        ).length > 0 ? (
          <EventsCarousel 
            events={events} 
          ...
          <div className="text-center">
            <p className="body-text mb-4">No events currently scheduled for Las Vegas.</p>
