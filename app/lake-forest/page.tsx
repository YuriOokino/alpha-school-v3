...
export default async function LakeForestPage() {
  const events = await loadEvents()
  const campus = campuses.find(c => c.name === "Lake Forest")
  
  if (!campus) {
    throw new Error("Lake Forest campus not found in campus data")
  }
  ...
  const welcomeRightColumn = (
    <>
      ...
      <p>Bringing Alpha School's three commitments—love school, learn 2x in 2 hours, and master life skills—to your city. <strong>Alpha Lake Forest is launching soon and now accepting applications.</strong></p>
    </>
  )
  
  // Load gallery images dynamically
  const galleryImages = hasGallery ? loadGalleryImages("Lake Forest") : []
    ...
    <main className="bg-[var(--color-bg-muted)]">
      ...
      <div className="alpha-section">
        <div className="flex justify-center">
          <VideoPlayer
            ...
            posterImage="/assets/feature-video-overlays/lake-forest-video-preview.webp"
            posterAlt="Lake Forest Campus Video Preview"
            aspectRatio="16/9"
      ...
      */}
      ...
      <section className="alpha-section bg-white">
        ...
        <EventList events={events} campusName="Lake Forest" />
      </section>
    </main>
  )
}
