...
export default async function RaleighPage() {
  ...
  const campus = campuses.find(c => c.name === "Raleigh")
  
  if (!campus) {
    throw new Error("Raleigh campus not found in campus data")
  }
  ...
  const welcomeRightColumn = (
    <>
      ...
      <p>Bringing Alpha School's three commitments—love school, learn 2x in 2 hours, and master life skills—to your city. <strong>Alpha Raleigh is launching soon and now accepting applications.</strong></p>
    </>
  )
  ...
  return (
    <main className="bg-[var(--color-bg-muted)]">
      ...
      <MediaHeading
        ...
        media={<img src="/assets/locations/raleigh/hero/raleigh-hero.webp" alt="Raleigh Campus" />}
      >
        Private School in Raleigh
      ...
      <div className="alpha-section">
        <div className="flex justify-center">
          <VideoPlayer
            ...
            posterImage="/assets/feature-video-overlays/raleigh-video-preview.webp"
            posterAlt="Raleigh Campus Video Preview"
            aspectRatio="16/9"
      ...
      */}
      ...
      <section className="alpha-section bg-white">
        <div className="campus-info">
          <div className="flex-1">
            <h2 className="heading-style-h2 mb-4">Raleigh Campus</h2>
      ...
      <section className="alpha-section bg-white">
        ...
        {events.filter(e => 
          e.locationTag.toLowerCase().includes("raleigh") || 
          e.title.toLowerCase().includes("raleigh") || 
          e.address.toLowerCase().includes("raleigh")
        ).length > 0 ? (
          <EventsCarousel 
            events={events} 
            locationFilter="raleigh" 
          ...
          <div className="text-center">
            <p className="body-text mb-4">No events currently scheduled for Raleigh.</p>
