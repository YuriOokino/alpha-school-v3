...
export default async function MiamiPage() {
  ...
  const welcomeRightColumn = (
    <>
      ...
      <p>Bringing Alpha School's three commitments—love school, learn 2x in 2 hours, and master life skills—to your city. <strong>Alpha Miami is launching soon and now accepting applications.</strong></p>
    </>
  )
    ...
    <main className="bg-[var(--color-bg-muted)]">
      ...
      <div className="alpha-section">
        <div className="flex justify-center">
          <VideoPlayer
            ...
            posterImage="/assets/feature-video-overlays/miami-video-preview.webp"
      ...
      */}
      ...
      <section className="alpha-section bg-white">
        ...
        <EventList events={events} campusName="Miami" />
      </section>
    </main>
  )
}
