...
export default async function MiamiPage() {
  ...
  const campus = campuses.find(c => c.name === "Miami")
  
  if (!campus) {
    throw new Error("Miami campus not found in campus data")
  }
  ...
  const welcomeLeftColumn = (
    <>
      <p className="mb-2">Alpha's Miami campus offers an educational experience that revolutionizes education, inspiring and motivating kids to be limitless.</p>
  ...
  const welcomeRightColumn = (
    <>
      ...
      <p>Alpha Miami is now delivering on their commitments to every student: love school, learn 2h a day, and master life skills.</p>
    </>
  )
  ...
  return (
    <main className="bg-[var(--color-bg-muted)]">
      ...
      <MediaHeading
        ...
        media={<img src="assets/locations/miami/hero/miami-hero.webp" alt="Miami Campus" />}
      >
      ...
      <div className="alpha-section">
        <div className="flex justify-center">
          <VideoPlayer
            videoUrl="https://youtu.be/pETkSYZoGWc?si=1RBnfOmlMATtqlHd"
            posterImage="/assets/locations/miami/overlays/miami-overlay.webp"
            posterAlt="Miami Campus Video Preview"
            aspectRatio="16/9"
      ...
      <section className="alpha-section bg-white">
        <div className="campus-info">
          <div className="flex-1">
            <h2 className="heading-style-h2 mb-4">Miami Campus</h2>
            <ul className="body-text mb-4">
              <li>
                <a 
                  href="https://www.google.com/maps/search/?api=1&query=8000+SW+56th+Street+Miami+FL+33155" 
                  target="_blank" 
            ...
            <p className="body-text mb-2">
              <strong>Email:</strong> admissions.miami@alpha.school
            </p>
            <CampusApplicationLink 
              campusName="Miami" 
      ...
      <section className="alpha-section bg-white">
        ...
        {events.filter(e => 
          e.locationTag.toLowerCase().includes("miami") || 
          e.title.toLowerCase().includes("miami") || 
          e.address.toLowerCase().includes("miami")
        ).length > 0 ? (
          <EventsCarousel 
            events={events} 
            locationFilter="miami" 
          ...
          <div className="text-center">
            <p className="body-text mb-4">No events currently scheduled for Miami.</p>
