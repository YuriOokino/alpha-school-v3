  ...
  return (
    <main className="bg-[var(--color-bg-muted)]">
      ...
      <MediaHeading
        ...
        media={<img src="/assets/locations/dallas/hero/dallas-hero.webp" alt="Dallas Campus" />}
      >
      ...
      */}
      ...
      <section className="alpha-section bg-white">
        <div className="campus-info">
          <div className="flex-1">
            <h2 className="heading-style-h2 mb-4">Dallas Campus</h2>
      ...
      <section className="alpha-section bg-white">
        ...
        {events.filter(e => 
          e.locationTag.toLowerCase().includes("dallas") || 
          e.title.toLowerCase().includes("dallas") || 
          e.address.toLowerCase().includes("dallas")
        ).length > 0 ? (
          <EventsCarousel 
            events={events} 
            locationFilter="dallas" 
          ...
          <div className="text-center">
            <p className="body-text mb-4">No events currently scheduled for Dallas.</p>
