...
export default async function PlanoPage() {
  ...
  const campus = campuses.find(c => c.name === "Plano")
  
  if (!campus) {
    throw new Error("Plano campus not found in campus data")
  }
  ...
  const welcomeRightColumn = (
    <>
      ...
      <p>Bringing Alpha School's three commitments—love school, learn 2x in 2 hours, and master life skills—to your city. <strong>Alpha Plano is launching soon and now accepting applications.</strong></p>
    </>
  )
  
  // Load gallery images dynamically
  const galleryImages = hasGallery ? loadGalleryImages("Plano") : []
    ...
    <main className="bg-[var(--color-bg-muted)]">
      ...
      <div className="alpha-section">
        <div className="flex justify-center">
          <VideoPlayer
            ...
            posterImage="/assets/feature-video-overlays/plano-video-preview.webp"
            posterAlt="Plano Campus Video Preview"
            aspectRatio="16/9"
      ...
      */}
      ...
      <section className="alpha-section bg-white">
        ...
        <EventList events={events} campusName="Plano" />
      </section>
    </main>
  )
}
