  ...
  return (
    <main className="bg-[var(--color-bg-muted)]">
      ...
      <MediaHeading
        ...
        media={<img src="/assets/locations/scottsdale/hero/scottsdale-hero.webp" alt="Scottsdale Campus" />}
      >
        Private School in Scottsdale
      ...
      */}
      ...
      <section className="alpha-section bg-white">
        <div className="campus-info">
          <div className="flex-1">
            <h2 className="heading-style-h2 mb-4">Scottsdale Campus</h2>
      ...
      <section className="alpha-section bg-white">
        ...
        {events.filter(e => 
          e.locationTag.toLowerCase().includes("scottsdale") || 
          e.title.toLowerCase().includes("scottsdale") || 
          e.address.toLowerCase().includes("scottsdale")
        ).length > 0 ? (
          <EventsCarousel 
            events={events} 
            locationFilter="scottsdale" 
          ...
          <div className="text-center">
            <p className="body-text mb-4">No events currently scheduled for Scottsdale.</p>
