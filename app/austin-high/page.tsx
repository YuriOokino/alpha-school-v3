...
export default async function AustinHighPage() {
  ...
  const campus = campuses.find(c => c.name === "Austin High")
  
  if (!campus) {
    throw new Error("Austin High campus not found in campus data")
  }
  ...
  const welcomeRightColumn = (
    <>
      ...
      <p>Bringing Alpha School's three commitments—love school, learn 2x in 2 hours, and master life skills—to your city. <strong>Alpha Austin High is launching soon and now accepting applications.</strong></p>
    </>
  )
  ...
  return (
    <main className="bg-[var(--color-bg-muted)]">
      ...
      <MediaHeading
        ...
        media={<img src="/assets/locations/austin-high/hero/austin-high-hero.webp" alt="Austin High Campus" />}
      >
        Private School in Austin High
      ...
      <div className="alpha-section">
        <div className="flex justify-center">
          <VideoPlayer
            ...
            posterImage="/assets/feature-video-overlays/austin-high-video-preview.webp"
            posterAlt="Austin High Campus Video Preview"
            aspectRatio="16/9"
      ...
      */}
      ...
      <section className="alpha-section bg-white">
        <div className="campus-info">
          <div className="flex-1">
            <h2 className="heading-style-h2 mb-4">Austin High Campus</h2>
      ...
      <section className="alpha-section bg-white">
        ...
        {events.filter(e => 
          e.locationTag.toLowerCase().includes("austin-high") || 
          e.title.toLowerCase().includes("austin-high") || 
          e.address.toLowerCase().includes("austin-high")
        ).length > 0 ? (
          <EventsCarousel 
            events={events} 
            locationFilter="austin-high" 
          ...
          <div className="text-center">
            <p className="body-text mb-4">No events currently scheduled for Austin High.</p>
