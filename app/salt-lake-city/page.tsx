...
export default async function SaltLakeCityPage() {
  const events = await loadEvents()
  const campus = campuses.find(c => c.name === "Salt Lake City")
  
  if (!campus) {
    throw new Error("Salt Lake City campus not found in campus data")
  }
  ...
  const welcomeRightColumn = (
    <>
      ...
      <p>Bringing Alpha School's three commitments—love school, learn 2x in 2 hours, and master life skills—to your city. <strong>Alpha Salt Lake City is launching soon and now accepting applications.</strong></p>
    </>
  )
  
  const galleryImages = [
    { src: "/assets/locations/salt-lake-city/gallery/salt-lake-city-1.webp", alt: "Salt Lake City campus photo" },
    { src: "/assets/locations/salt-lake-city/gallery/salt-lake-city-2.webp", alt: "Salt Lake City campus photo" },
    { src: "/assets/locations/salt-lake-city/gallery/salt-lake-city-3.webp", alt: "Salt Lake City campus photo" },
    { src: "/assets/locations/salt-lake-city/gallery/salt-lake-city-4.webp", alt: "Salt Lake City campus photo" },
    { src: "/assets/locations/salt-lake-city/gallery/salt-lake-city-5.webp", alt: "Salt Lake City campus photo" },
    { src: "/assets/locations/salt-lake-city/gallery/salt-lake-city-6.webp", alt: "Salt Lake City campus photo" },
    { src: "/assets/locations/salt-lake-city/gallery/salt-lake-city-7.webp", alt: "Salt Lake City campus photo" },
    { src: "/assets/locations/salt-lake-city/gallery/salt-lake-city-8.webp", alt: "Salt Lake City campus photo" },
    { src: "/assets/locations/salt-lake-city/gallery/salt-lake-city-9.webp", alt: "Salt Lake City campus photo" },
    { src: "/assets/locations/salt-lake-city/gallery/salt-lake-city-10.webp", alt: "Salt Lake City campus photo" },
    { src: "/assets/locations/salt-lake-city/gallery/salt-lake-city-11.webp", alt: "Salt Lake City campus photo" },
    { src: "/assets/locations/salt-lake-city/gallery/salt-lake-city-12.webp", alt: "Salt Lake City campus photo" }
  ]
  ...
  return (
    <main className="bg-[var(--color-bg-muted)]">
      ...
      <MediaHeading
        ...
        media={<img src="/assets/locations/salt-lake-city/hero/salt-lake-city-hero.webp" alt="Salt Lake City Campus" />}
      >
        Private School in Salt Lake City
      ...
      <div className="alpha-section">
        <div className="flex justify-center">
          <VideoPlayer
            ...
            posterImage="/assets/feature-video-overlays/salt-lake-city-video-preview.webp"
            posterAlt="Salt Lake City Campus Video Preview"
            aspectRatio="16/9"
      ...
      */}
      ...
      <section className="alpha-section bg-white">
        <div className="campus-info">
          <div className="flex-1">
            <h2 className="heading-style-h2 mb-4">Salt Lake City Campus</h2>
      ...
      <section className="alpha-section bg-white">
        ...
        {events.filter(e => 
          e.locationTag.toLowerCase().includes("salt-lake-city") || 
          e.title.toLowerCase().includes("salt-lake-city") || 
          e.address.toLowerCase().includes("salt-lake-city")
        ).length > 0 ? (
          <EventsCarousel 
            events={events} 
            locationFilter="salt-lake-city" 
          ...
          <div className="text-center">
            <p className="body-text mb-4">No events currently scheduled for Salt Lake City.</p>
