...
export default async function DenverPage() {
  ...
  const campus = campuses.find(c => c.name === "Denver")
  
  if (!campus) {
    throw new Error("Denver campus not found in campus data")
  }
  ...
  const welcomeRightColumn = (
    <>
      ...
      <p>Bringing Alpha School's three commitments—love school, learn 2x in 2 hours, and master life skills—to your city. <strong>Alpha Denver is launching soon and now accepting applications.</strong></p>
    </>
  )
  
  const galleryImages = [
    { src: "/assets/locations/denver/gallery/denver-1.webp", alt: "Denver campus photo" },
    { src: "/assets/locations/denver/gallery/denver-2.webp", alt: "Denver campus photo" },
    { src: "/assets/locations/denver/gallery/denver-3.webp", alt: "Denver campus photo" },
    { src: "/assets/locations/denver/gallery/denver-4.webp", alt: "Denver campus photo" },
    { src: "/assets/locations/denver/gallery/denver-5.webp", alt: "Denver campus photo" },
    { src: "/assets/locations/denver/gallery/denver-6.webp", alt: "Denver campus photo" },
    { src: "/assets/locations/denver/gallery/denver-7.webp", alt: "Denver campus photo" },
    { src: "/assets/locations/denver/gallery/denver-8.webp", alt: "Denver campus photo" },
    { src: "/assets/locations/denver/gallery/denver-9.webp", alt: "Denver campus photo" },
    { src: "/assets/locations/denver/gallery/denver-10.webp", alt: "Denver campus photo" },
    { src: "/assets/locations/denver/gallery/denver-11.webp", alt: "Denver campus photo" },
    { src: "/assets/locations/denver/gallery/denver-12.webp", alt: "Denver campus photo" }
  ]
  ...
  return (
    <main className="bg-[var(--color-bg-muted)]">
      ...
      <MediaHeading
        ...
        media={<img src="/assets/locations/denver/hero/denver-hero.webp" alt="Denver Campus" />}
      >
        Private School in Denver
      ...
      <div className="alpha-section">
        <div className="flex justify-center">
          <VideoPlayer
            ...
            posterImage="/assets/feature-video-overlays/denver-video-preview.webp"
            posterAlt="Denver Campus Video Preview"
            aspectRatio="16/9"
      ...
      */}
      ...
      <section className="alpha-section bg-white">
        <div className="campus-info">
          <div className="flex-1">
            <h2 className="heading-style-h2 mb-4">Denver Campus</h2>
      ...
      <section className="alpha-section bg-white">
        ...
        {events.filter(e => 
          e.locationTag.toLowerCase().includes("denver") || 
          e.title.toLowerCase().includes("denver") || 
          e.address.toLowerCase().includes("denver")
        ).length > 0 ? (
          <EventsCarousel 
            events={events} 
          ...
          <div className="text-center">
            <p className="body-text mb-4">No events currently scheduled for Denver.</p>
