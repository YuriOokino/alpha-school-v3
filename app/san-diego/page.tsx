...
export default async function SanDiegoPage() {
  ...
  const campus = campuses.find(c => c.name === "San Diego")
  
  if (!campus) {
    throw new Error("San Diego campus not found in campus data")
  }
  ...
  const welcomeRightColumn = (
    <>
      ...
      <p>Bringing Alpha School's three commitments—love school, learn 2x in 2 hours, and master life skills—to your city. <strong>Alpha San Diego is launching soon and now accepting applications.</strong></p>
    </>
  )
  
  const galleryImages = [
    { src: "/assets/locations/san-diego/gallery/san-diego-1.webp", alt: "San Diego campus photo" },
    { src: "/assets/locations/san-diego/gallery/san-diego-2.webp", alt: "San Diego campus photo" },
    { src: "/assets/locations/san-diego/gallery/san-diego-3.webp", alt: "San Diego campus photo" },
    { src: "/assets/locations/san-diego/gallery/san-diego-4.webp", alt: "San Diego campus photo" },
    { src: "/assets/locations/san-diego/gallery/san-diego-5.webp", alt: "San Diego campus photo" },
    { src: "/assets/locations/san-diego/gallery/san-diego-6.webp", alt: "San Diego campus photo" },
    { src: "/assets/locations/san-diego/gallery/san-diego-7.webp", alt: "San Diego campus photo" },
    { src: "/assets/locations/san-diego/gallery/san-diego-8.webp", alt: "San Diego campus photo" },
    { src: "/assets/locations/san-diego/gallery/san-diego-9.webp", alt: "San Diego campus photo" },
    { src: "/assets/locations/san-diego/gallery/san-diego-10.webp", alt: "San Diego campus photo" },
    { src: "/assets/locations/san-diego/gallery/san-diego-11.webp", alt: "San Diego campus photo" },
    { src: "/assets/locations/san-diego/gallery/san-diego-12.webp", alt: "San Diego campus photo" }
  ]
  ...
  return (
    <main className="bg-[var(--color-bg-muted)]">
      ...
      <MediaHeading
        ...
        media={<img src="/assets/locations/san-diego/hero/san-diego-hero.webp" alt="San Diego Campus" />}
      >
      ...
      <div className="alpha-section">
        <div className="flex justify-center">
          <VideoPlayer
            ...
            posterImage="/assets/feature-video-overlays/san-diego-video-preview.webp"
            posterAlt="San Diego Campus Video Preview"
            aspectRatio="16/9"
      ...
      */}
      ...
      <section className="alpha-section bg-white">
        <div className="campus-info">
          <div className="flex-1">
            <h2 className="heading-style-h2 mb-4">San Diego Campus</h2>
      ...
      <section className="alpha-section bg-white">
        ...
        {events.filter(e => 
          e.locationTag.toLowerCase().includes("san-diego") || 
          e.title.toLowerCase().includes("san-diego") || 
          e.address.toLowerCase().includes("san-diego")
        ).length > 0 ? (
          <EventsCarousel 
            events={events} 
            locationFilter="san-diego" 
          ...
          <div className="text-center">
            <p className="body-text mb-4">No events currently scheduled for San Diego.</p>
