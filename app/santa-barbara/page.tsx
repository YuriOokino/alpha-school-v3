  ...
  return (
    <main className="bg-[var(--color-bg-muted)]">
      ...
      <MediaHeading
        ...
        media={<img src="/assets/locations/santa-barbara/hero/santa-barbara-hero.webp" alt="Santa Barbara Campus" />}
      >
        Private School in Santa Barbara
      ...
      */}
      ...
      <section className="alpha-section bg-white">
        <div className="campus-info">
          <div className="flex-1">
            <h2 className="heading-style-h2 mb-4">Santa Barbara Campus</h2>
      ...
      <section className="alpha-section bg-white">
        ...
        {events.filter(e => 
          e.locationTag.toLowerCase().includes("santa-barbara") || 
          e.title.toLowerCase().includes("santa-barbara") || 
          e.address.toLowerCase().includes("santa-barbara")
        ).length > 0 ? (
          <EventsCarousel 
            events={events} 
            locationFilter="santa-barbara" 
