...
export default async function CharlottePage() {
  ...
  const campus = campuses.find(c => c.name === "Charlotte")
  
  if (!campus) {
    throw new Error("Charlotte campus not found in campus data")
  }
  ...
  const welcomeRightColumn = (
    <>
      ...
      <p>Bringing Alpha School's three commitments—love school, learn 2x in 2 hours, and master life skills—to your city. <strong>Alpha Charlotte is launching soon and now accepting applications.</strong></p>
    </>
  )
  ...
  return (
    <main className="bg-[var(--color-bg-muted)]">
      ...
      <MediaHeading
        ...
        media={<img src="/assets/locations/charlotte/hero/charlotte-hero.webp" alt="Charlotte Campus" />}
      >
      ...
      <div className="alpha-section">
        <div className="flex justify-center">
          <VideoPlayer
            ...
            posterImage="/assets/feature-video-overlays/charlotte-video-preview.webp"
            posterAlt="Charlotte Campus Video Preview"
            aspectRatio="16/9"
      ...
      */}
      ...
      <section className="alpha-section bg-white">
        <div className="campus-info">
          <div className="flex-1">
            <h2 className="heading-style-h2 mb-4">Charlotte Campus</h2>
      ...
      <section className="alpha-section bg-white">
        ...
        {events.filter(e => 
          e.locationTag.toLowerCase().includes("charlotte") || 
          e.title.toLowerCase().includes("charlotte") || 
          e.address.toLowerCase().includes("charlotte")
        ).length > 0 ? (
          <EventsCarousel 
            events={events} 
            locationFilter="charlotte" 
          ...
          <div className="text-center">
            <p className="body-text mb-4">No events currently scheduled for Charlotte.</p>
