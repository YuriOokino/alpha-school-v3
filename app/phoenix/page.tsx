...
export default async function PhoenixPage() {
  ...
  const campus = campuses.find(c => c.name === "Phoenix")
  
  if (!campus) {
    throw new Error("Phoenix campus not found in campus data")
  }
  ...
  const welcomeRightColumn = (
    <>
      ...
      <p>Bringing Alpha School's three commitments—love school, learn 2x in 2 hours, and master life skills—to your city. <strong>Alpha Phoenix is launching soon and now accepting applications.</strong></p>
    </>
  )
  
  const galleryImages = [
    { src: "/assets/locations/phoenix/gallery/phoenix-1.webp", alt: "Phoenix campus photo" },
    { src: "/assets/locations/phoenix/gallery/phoenix-2.webp", alt: "Phoenix campus photo" },
    { src: "/assets/locations/phoenix/gallery/phoenix-3.webp", alt: "Phoenix campus photo" },
    { src: "/assets/locations/phoenix/gallery/phoenix-4.webp", alt: "Phoenix campus photo" },
    { src: "/assets/locations/phoenix/gallery/phoenix-5.webp", alt: "Phoenix campus photo" },
    { src: "/assets/locations/phoenix/gallery/phoenix-6.webp", alt: "Phoenix campus photo" },
    { src: "/assets/locations/phoenix/gallery/phoenix-7.webp", alt: "Phoenix campus photo" },
    { src: "/assets/locations/phoenix/gallery/phoenix-8.webp", alt: "Phoenix campus photo" },
    { src: "/assets/locations/phoenix/gallery/phoenix-9.webp", alt: "Phoenix campus photo" },
    { src: "/assets/locations/phoenix/gallery/phoenix-10.webp", alt: "Phoenix campus photo" },
    { src: "/assets/locations/phoenix/gallery/phoenix-11.webp", alt: "Phoenix campus photo" },
    { src: "/assets/locations/phoenix/gallery/phoenix-12.webp", alt: "Phoenix campus photo" }
  ]
  ...
  return (
    <main className="bg-[var(--color-bg-muted)]">
      ...
      <MediaHeading
        ...
        media={<img src="/assets/locations/phoenix/hero/phoenix-hero.webp" alt="Phoenix Campus" />}
      >
      ...
      <div className="alpha-section">
        <div className="flex justify-center">
          <VideoPlayer
            ...
            posterImage="/assets/feature-video-overlays/phoenix-video-preview.webp"
            posterAlt="Phoenix Campus Video Preview"
            aspectRatio="16/9"
      ...
      */}
      ...
      <section className="alpha-section bg-white">
        <div className="campus-info">
          <div className="flex-1">
            <h2 className="heading-style-h2 mb-4">Phoenix Campus</h2>
      ...
      <section className="alpha-section bg-white">
        ...
        {events.filter(e => 
          e.locationTag.toLowerCase().includes("phoenix") || 
          e.title.toLowerCase().includes("phoenix") || 
          e.address.toLowerCase().includes("phoenix")
        ).length > 0 ? (
          <EventsCarousel 
            events={events} 
            locationFilter="phoenix" 
          ...
          <div className="text-center">
            <p className="body-text mb-4">No events currently scheduled for Phoenix.</p>
