...
export default async function SanAntonioPage() {
  ...
  const campus = campuses.find(c => c.name === "San Antonio")
  
  if (!campus) {
    throw new Error("San Antonio campus not found in campus data")
  }
  ...
  const welcomeRightColumn = (
    <>
      ...
      <p>Bringing Alpha School's three commitments—love school, learn 2x in 2 hours, and master life skills—to your city. <strong>Alpha San Antonio is launching soon and now accepting applications.</strong></p>
    </>
  )
  
  const galleryImages = [
    { src: "/assets/locations/san-antonio/gallery/san-antonio-1.webp", alt: "San Antonio campus photo" },
    { src: "/assets/locations/san-antonio/gallery/san-antonio-2.webp", alt: "San Antonio campus photo" },
    { src: "/assets/locations/san-antonio/gallery/san-antonio-3.webp", alt: "San Antonio campus photo" },
    { src: "/assets/locations/san-antonio/gallery/san-antonio-4.webp", alt: "San Antonio campus photo" },
    { src: "/assets/locations/san-antonio/gallery/san-antonio-5.webp", alt: "San Antonio campus photo" },
    { src: "/assets/locations/san-antonio/gallery/san-antonio-6.webp", alt: "San Antonio campus photo" },
    { src: "/assets/locations/san-antonio/gallery/san-antonio-7.webp", alt: "San Antonio campus photo" },
    { src: "/assets/locations/san-antonio/gallery/san-antonio-8.webp", alt: "San Antonio campus photo" },
    { src: "/assets/locations/san-antonio/gallery/san-antonio-9.webp", alt: "San Antonio campus photo" },
    { src: "/assets/locations/san-antonio/gallery/san-antonio-10.webp", alt: "San Antonio campus photo" },
    { src: "/assets/locations/san-antonio/gallery/san-antonio-11.webp", alt: "San Antonio campus photo" },
    { src: "/assets/locations/san-antonio/gallery/san-antonio-12.webp", alt: "San Antonio campus photo" }
  ]
  ...
  return (
    <main className="bg-[var(--color-bg-muted)]">
      ...
      <MediaHeading
        ...
        media={<img src="/assets/locations/san-antonio/hero/san-antonio-hero.webp" alt="San Antonio Campus" />}
      >
      ...
      <div className="alpha-section">
        <div className="flex justify-center">
          <VideoPlayer
            ...
            posterImage="/assets/feature-video-overlays/san-antonio-video-preview.webp"
            posterAlt="San Antonio Campus Video Preview"
            aspectRatio="16/9"
      ...
      */}
      ...
      <section className="alpha-section bg-white">
        <div className="campus-info">
          <div className="flex-1">
            <h2 className="heading-style-h2 mb-4">San Antonio Campus</h2>
      ...
      <section className="alpha-section bg-white">
        ...
        {events.filter(e => 
          e.locationTag.toLowerCase().includes("san-antonio") || 
          e.title.toLowerCase().includes("san-antonio") || 
          e.address.toLowerCase().includes("san-antonio")
        ).length > 0 ? (
          <EventsCarousel 
            events={events} 
            locationFilter="san-antonio" 
          ...
          <div className="text-center">
            <p className="body-text mb-4">No events currently scheduled for San Antonio.</p>
