...
export default async function SeattlePage() {
  const events = await loadEvents()
  const campus = campuses.find(c => c.name === "Seattle")
  
  if (!campus) {
    throw new Error("Seattle campus not found in campus data")
  }
  ...
  const welcomeRightColumn = (
    <>
      ...
      <p>Bringing Alpha School's three commitments—love school, learn 2x in 2 hours, and master life skills—to your city. <strong>Alpha Seattle is launching soon and now accepting applications.</strong></p>
    </>
  )
  
  const galleryImages = [
    { src: "/assets/locations/seattle/gallery/seattle-1.webp", alt: "Seattle campus photo" },
    { src: "/assets/locations/seattle/gallery/seattle-2.webp", alt: "Seattle campus photo" },
    { src: "/assets/locations/seattle/gallery/seattle-3.webp", alt: "Seattle campus photo" },
    { src: "/assets/locations/seattle/gallery/seattle-4.webp", alt: "Seattle campus photo" },
    { src: "/assets/locations/seattle/gallery/seattle-5.webp", alt: "Seattle campus photo" },
    { src: "/assets/locations/seattle/gallery/seattle-6.webp", alt: "Seattle campus photo" },
    { src: "/assets/locations/seattle/gallery/seattle-7.webp", alt: "Seattle campus photo" },
    { src: "/assets/locations/seattle/gallery/seattle-8.webp", alt: "Seattle campus photo" },
    { src: "/assets/locations/seattle/gallery/seattle-9.webp", alt: "Seattle campus photo" },
    { src: "/assets/locations/seattle/gallery/seattle-10.webp", alt: "Seattle campus photo" },
    { src: "/assets/locations/seattle/gallery/seattle-11.webp", alt: "Seattle campus photo" },
    { src: "/assets/locations/seattle/gallery/seattle-12.webp", alt: "Seattle campus photo" }
  ]
  ...
  return (
    <main className="bg-[var(--color-bg-muted)]">
      ...
      <MediaHeading
        ...
        media={<img src="/assets/locations/seattle/hero/seattle-hero.webp" alt="Seattle Campus" />}
      >
        Private School in Seattle
      ...
      <div className="alpha-section">
        <div className="flex justify-center">
          <VideoPlayer
            ...
            posterImage="/assets/feature-video-overlays/seattle-video-preview.webp"
            posterAlt="Seattle Campus Video Preview"
            aspectRatio="16/9"
      ...
      */}
      ...
      <section className="alpha-section bg-white">
        <div className="campus-info">
          <div className="flex-1">
            <h2 className="heading-style-h2 mb-4">Seattle Campus</h2>
      ...
      <section className="alpha-section bg-white">
        ...
        {events.filter(e => 
          e.locationTag.toLowerCase().includes("seattle") || 
          e.title.toLowerCase().includes("seattle") || 
          e.address.toLowerCase().includes("seattle")
        ).length > 0 ? (
          <EventsCarousel 
            events={events} 
          ...
          <div className="text-center">
            <p className="body-text mb-4">No events currently scheduled for Seattle.</p>
