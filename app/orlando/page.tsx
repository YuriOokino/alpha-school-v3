...
export default async function OrlandoPage() {
  ...
  const campus = campuses.find(c => c.name === "Orlando")
  
  if (!campus) {
    throw new Error("Orlando campus not found in campus data")
  }
  ...
  const welcomeRightColumn = (
    <>
      ...
      <p>Bringing Alpha School's three commitments—love school, learn 2x in 2 hours, and master life skills—to your city. <strong>Alpha Orlando is launching soon and now accepting applications.</strong></p>
    </>
  )
  
  const galleryImages = [
    { src: "/assets/locations/orlando/gallery/orlando-1.webp", alt: "Orlando campus photo" },
    { src: "/assets/locations/orlando/gallery/orlando-2.webp", alt: "Orlando campus photo" },
    { src: "/assets/locations/orlando/gallery/orlando-3.webp", alt: "Orlando campus photo" },
    { src: "/assets/locations/orlando/gallery/orlando-4.webp", alt: "Orlando campus photo" },
    { src: "/assets/locations/orlando/gallery/orlando-5.webp", alt: "Orlando campus photo" },
    { src: "/assets/locations/orlando/gallery/orlando-6.webp", alt: "Orlando campus photo" },
    { src: "/assets/locations/orlando/gallery/orlando-7.webp", alt: "Orlando campus photo" },
    { src: "/assets/locations/orlando/gallery/orlando-8.webp", alt: "Orlando campus photo" },
    { src: "/assets/locations/orlando/gallery/orlando-9.webp", alt: "Orlando campus photo" },
    { src: "/assets/locations/orlando/gallery/orlando-10.webp", alt: "Orlando campus photo" },
    { src: "/assets/locations/orlando/gallery/orlando-11.webp", alt: "Orlando campus photo" },
    { src: "/assets/locations/orlando/gallery/orlando-12.webp", alt: "Orlando campus photo" }
  ]
  ...
  return (
    <main className="bg-[var(--color-bg-muted)]">
      ...
      <MediaHeading
        ...
        media={<img src="/assets/locations/orlando/hero/orlando-hero.webp" alt="Orlando Campus" />}
      >
      ...
      <div className="alpha-section">
        <div className="flex justify-center">
          <VideoPlayer
            ...
            posterImage="/assets/feature-video-overlays/orlando-video-preview.webp"
            posterAlt="Orlando Campus Video Preview"
            aspectRatio="16/9"
      ...
      */}
      ...
      <section className="alpha-section bg-white">
        <div className="campus-info">
          <div className="flex-1">
            <h2 className="heading-style-h2 mb-4">Orlando Campus</h2>
      ...
      <section className="alpha-section bg-white">
        ...
        {events.filter(e => 
          e.locationTag.toLowerCase().includes("orlando") || 
          e.title.toLowerCase().includes("orlando") || 
          e.address.toLowerCase().includes("orlando")
        ).length > 0 ? (
          <EventsCarousel 
            events={events} 
          ...
          <div className="text-center">
            <p className="body-text mb-4">No events currently scheduled for Orlando.</p>
