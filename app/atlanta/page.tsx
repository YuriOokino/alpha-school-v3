...
export default async function AtlantaPage() {
  ...
  const campus = campuses.find(c => c.name === "Atlanta")
  
  if (!campus) {
    throw new Error("Atlanta campus not found in campus data")
  }
  ...
  const welcomeRightColumn = (
    <>
      ...
      <p>Bringing Alpha School's three commitments—love school, learn 2x in 2 hours, and master life skills—to your city. <strong>Alpha Atlanta is launching soon and now accepting applications.</strong></p>
    </>
  )
  
  const galleryImages = [
    { src: "/assets/locations/atlanta/gallery/atlanta-1.webp", alt: "Atlanta campus photo" },
    { src: "/assets/locations/atlanta/gallery/atlanta-2.webp", alt: "Atlanta campus photo" },
    { src: "/assets/locations/atlanta/gallery/atlanta-3.webp", alt: "Atlanta campus photo" },
    { src: "/assets/locations/atlanta/gallery/atlanta-4.webp", alt: "Atlanta campus photo" },
    { src: "/assets/locations/atlanta/gallery/atlanta-5.webp", alt: "Atlanta campus photo" },
    { src: "/assets/locations/atlanta/gallery/atlanta-6.webp", alt: "Atlanta campus photo" },
    { src: "/assets/locations/atlanta/gallery/atlanta-7.webp", alt: "Atlanta campus photo" },
    { src: "/assets/locations/atlanta/gallery/atlanta-8.webp", alt: "Atlanta campus photo" },
    { src: "/assets/locations/atlanta/gallery/atlanta-9.webp", alt: "Atlanta campus photo" },
    { src: "/assets/locations/atlanta/gallery/atlanta-10.webp", alt: "Atlanta campus photo" },
    { src: "/assets/locations/atlanta/gallery/atlanta-11.webp", alt: "Atlanta campus photo" },
    { src: "/assets/locations/atlanta/gallery/atlanta-12.webp", alt: "Atlanta campus photo" }
  ]
  ...
  return (
    <main className="bg-[var(--color-bg-muted)]">
      ...
      <MediaHeading
        ...
        media={<img src="/assets/locations/atlanta/hero/atlanta-hero.webp" alt="Atlanta Campus" />}
      >
      ...
      <div className="alpha-section">
        <div className="flex justify-center">
          <VideoPlayer
            ...
            posterImage="/assets/feature-video-overlays/atlanta-video-preview.webp"
            posterAlt="Atlanta Campus Video Preview"
            aspectRatio="16/9"
      ...
      */}
      ...
      <section className="alpha-section bg-white">
        <div className="campus-info">
          <div className="flex-1">
            <h2 className="heading-style-h2 mb-4">Atlanta Campus</h2>
      ...
      <section className="alpha-section bg-white">
        ...
        {events.filter(e => 
          e.locationTag.toLowerCase().includes("atlanta") || 
          e.title.toLowerCase().includes("atlanta") || 
          e.address.toLowerCase().includes("atlanta")
        ).length > 0 ? (
          <EventsCarousel 
            events={events} 
          ...
          <div className="text-center">
            <p className="body-text mb-4">No events currently scheduled for Atlanta.</p>
