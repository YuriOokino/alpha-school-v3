...
export default async function AustinPage() {
  ...
  const campus = campuses.find(c => c.name === "Austin")
  
  if (!campus) {
    throw new Error("Austin campus not found in campus data")
  }
  ...
  const welcomeRightColumn = (
    <>
      ...
      <p>Bringing Alpha School's three commitments—love school, learn 2x in 2 hours, and master life skills—to your city. <strong>Alpha Austin is launching soon and now accepting applications.</strong></p>
    </>
  )
  
  const galleryImages = [
    { src: "/assets/locations/austin/gallery/austin-1.webp", alt: "Austin campus photo" },
    { src: "/assets/locations/austin/gallery/austin-2.webp", alt: "Austin campus photo" },
    { src: "/assets/locations/austin/gallery/austin-3.webp", alt: "Austin campus photo" },
    { src: "/assets/locations/austin/gallery/austin-4.webp", alt: "Austin campus photo" },
    { src: "/assets/locations/austin/gallery/austin-5.webp", alt: "Austin campus photo" },
    { src: "/assets/locations/austin/gallery/austin-6.webp", alt: "Austin campus photo" },
    { src: "/assets/locations/austin/gallery/austin-7.webp", alt: "Austin campus photo" },
    { src: "/assets/locations/austin/gallery/austin-8.webp", alt: "Austin campus photo" },
    { src: "/assets/locations/austin/gallery/austin-9.webp", alt: "Austin campus photo" },
    { src: "/assets/locations/austin/gallery/austin-10.webp", alt: "Austin campus photo" },
    { src: "/assets/locations/austin/gallery/austin-11.webp", alt: "Austin campus photo" },
    { src: "/assets/locations/austin/gallery/austin-12.webp", alt: "Austin campus photo" }
  ]
    ...
    <main className="bg-[var(--color-bg-muted)]">
      ...
      */}
      ...
      <section className="alpha-section bg-white">
        ...
        <EventList events={events} campusName="Austin" />
      </section>
    </main>
  )
}