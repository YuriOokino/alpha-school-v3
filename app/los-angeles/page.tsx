  ...
  return (
    <main className="bg-[var(--color-bg-muted)]">
      ...
      <MediaHeading
        ...
        media={<img src="/assets/locations/los-angeles/hero/los-angeles-hero.webp" alt="Los Angeles Campus" />}
      >
      ...
      */}
      ...
      <section className="alpha-section bg-white">
        <div className="campus-info">
          <div className="flex-1">
            <h2 className="heading-style-h2 mb-4">Los Angeles Campus</h2>
      ...
      <section className="alpha-section bg-white">
        ...
        {events.filter(e => 
          e.locationTag.toLowerCase().includes("los-angeles") || 
          e.title.toLowerCase().includes("los-angeles") || 
          e.address.toLowerCase().includes("los-angeles")
        ).length > 0 ? (
          <EventsCarousel 
            events={events} 
          ...
          <div className="text-center">
            <p className="body-text mb-4">No events currently scheduled for Los Angeles.</p>
