...
export default async function FortWorthPage() {
  ...
  const welcomeRightColumn = (
    <>
      <p className="mb-2">At Alpha, we believe that students thrive when they are engaged, challenged, and inspired by their learning environment. Our innovative model fosters a love of learning, encourages independence, and equips students with the tools they need to succeed academically and in life.</p>
      <p>Bringing Alpha School's three commitments—love school, learn 2x in 2 hours, and master life skills—to your city. <strong>Alpha Fort Worth is launching in Fall 2025 and now accepting applications.</strong></p>
    </>
  )
  ...
  return (
    <main className="bg-[var(--color-bg-muted)]">
      ...
      <MediaHeading
        ...
        media={<img src="/assets/locations/fort-worth/hero/fort-worth-hero.webp" alt="Fort Worth Campus" />}
      >
        Private School in Fort Worth
        ...
        <div className="campus-info">
          ...
          <div className="flex-1">
            ...
            <div className="space-y-2">
              ...
              <Button variant="outline" radius="small" className="outline-[var(--color-dark-green)] icon-text-centered uppercase" href="/downloads/Alpha School Fort Worth Flipbook.pdf" target="_blank">
                View brochure
                <span className="material-icons-outlined">file_download</span>
              </Button>
            </div>
