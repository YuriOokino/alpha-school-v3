...
export default async function DoradoPage() {
  const events = await loadEvents()
  const campus = campuses.find(c => c.name === "Dorado")
  
  if (!campus) {
    throw new Error("Dorado campus not found in campus data")
  }
  ...
  const welcomeRightColumn = (
    <>
      ...
      <p>Bringing Alpha School's three commitments—love school, learn 2x in 2 hours, and master life skills—to your city. <strong>Alpha Dorado is launching soon and now accepting applications.</strong></p>
    </>
  )
  
  // Load gallery images dynamically
  const galleryImages = hasGallery ? loadGalleryImages("Dorado") : []
    ...
    <main className="bg-[var(--color-bg-muted)]">
      ...
      <div className="alpha-section">
        <div className="flex justify-center">
          <VideoPlayer
            ...
            posterImage="/assets/feature-video-overlays/dorado-video-preview.webp"
            posterAlt="Dorado Campus Video Preview"
            aspectRatio="16/9"
      ...
      */}
      ...
      <section className="alpha-section bg-white">
        ...
        <EventList events={events} campusName="Dorado" />
      </section>
    </main>
  )
}
