...
export default async function HoustonPage() {
  ...
  const welcomeRightColumn = (
    <>
      ...
      <p>Bringing Alpha School's three commitments—love school, learn 2x in 2 hours, and master life skills—to your city. <strong>Alpha Houston is launching in Fall 2025 and now accepting applications.</strong></p>
    </>
  )
  ...
  return (
    <main className="bg-[var(--color-bg-muted)]">
      ...
      <MediaHeading
        ...
        media={<img src="/assets/locations/houston/hero/houston-hero.webp" alt="Houston Campus" />}
      >
        ...
        <div className="campus-info">
          ...
          <div className="flex-1">
            ...
            <div className="space-y-2">
              ...
              <Button variant="outline" radius="small" className="outline-[var(--color-dark-green)] icon-text-centered uppercase" href="/assets/locations/houston/downloads/Alpha School Houston Flipbook.pdf" target="_blank">
                View brochure
                <span className="material-icons-outlined">file_download</span>
              </Button>
            </div>
